...
def test_get_duples1():
    ...
    actual1 = _get_duples(outer)
    actual2 = _get_duples(inner_i1)
    actual3 = _get_duples(inner_i2)
    actual4 = _get_duples(inner_i3)
...
def test_get_non_duples1():
    ...
    inner_i2 = '[100.0, (200.0, 200.0), 300.0, (100,300.0)]'
    inner_i3 = '[100.0, (200.0, 200.0), 300, (100.0,300),(100,300.0)]'
    actual1 = _get_non_duples(outer)
    actual2 = _get_non_duples(inner_i1)
    actual3 = _get_non_duples(inner_i2)
    actual4 = _get_non_duples(inner_i3)
    expected1 = [(0, 300.0)]
...
def test_get_outer1():
    ...
    actual1 = _get_outer('400')
    actual2 = _get_outer('400.0')
    actual3 = _get_outer('(300,100)')
    expected1 = 400.0
    expected2 = 400.0
...
def test_get_inner_i1():
    ...
    actual = _get_inner_i(inner_i1)
    nt.assert_equal(actual, expected)


def test_get_middle1():
    '''Check get a float regardless of symmetric 'S'.'''
    actual1 = _get_middle('800')
    actual2 = _get_middle('800.0')
    actual3 = _get_middle('400S')
    expected = 800.0
...
def test_unfold_geometry1():
    ...
    middle = 800.0
    actual = _unfold_geometry(outer, inner_i, middle)
    nt.assert_equal(actual, expected)
